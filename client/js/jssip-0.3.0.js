...
RTCMediaHandler.prototype = {
  ...
  createAnswer: function(onSuccess, onFailure) {
    ...
    this.onIceCompleted = function() {
      if (!sent) {
        sent = true;
var mysdp = self.peerConnection.localDescription.sdp;
console.log('jopastart', offer, 'jopaend');
mysdp = mysdp.replace('RTP/SAVPF', 'RTP/SAVP');
console.log('jopastart2', offer, 'jopaend2');
...
console.log('jopastart', offer, 'jopaend');
offer = offer.replace('RTP/SAVPF', 'RTP/SAVP');
console.log('jopastart2', offer, 'jopaend2');
